...
public:
    ...
    TestCase* GetCurrentTestCase() { return CurrentTestCase;}
...
#define ZVOICE_TEST_(testcase_name) \
...
#define ZVTEST(testcase_name) \
    ZVOICE_TEST_(testcase_name)
...
#define EXPECT_EQ(m, n) \
    if (m != n) \
    { \
        UnitTest::GetInstance()->GetCurrentTestCase()->nTestResult = 0; \
